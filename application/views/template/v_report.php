...
<head>
    ...
    <title>SIM ABSENSI Beta Version 1.1 - Kementerian Sosial</title>
...
<body>
  <div id="page-wrapper">
    ...
    <?php
      foreach ($jum_pegawai as $jum_peg) {
        ...
        <a href="<?php echo base_url() ?>Ctrl_Beranda"><i class="fa fa-home fa-fw"></i></a>
        <?php
        echo "</p></br></hr>";
      }
    ?>
  ...
  <div class="row">
      ...
      <div class="col-sm-1"></div>
      <div class="col-sm-1">
        <?php echo form_open('Ctrl_page/export_excell');?>
