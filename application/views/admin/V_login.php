...
<html lang="en">
<head>
	<title>SIM ABSENSI Kementerian Sosial - Beta Version</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url() ?>assets/Login_v3/images/kemensos.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url('index.php/Ctrl_Login/aksi_login'); ?>" method="post">
